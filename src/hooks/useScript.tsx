/**
 * This is almost a complete copy of the package `react-script-hook`,
 * however that package has not been updated in 2 years and has an edge case bug in the loading/unmounting interaction
 * when used in hooks.
 */
...
export default function useScript({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // These are the only changes from the previous hook package [lines 126-134]
